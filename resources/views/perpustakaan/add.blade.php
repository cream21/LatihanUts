                ...
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('perpus.save-perpus') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="nb" name="nama_buku" class="form-control" value="{{old('nama_buku')}}" autocomplete="off">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="pb">Penerbit</label>
                                    <input type="text" id="pb" name="penerbit" class="form-control" value="{{old('penerbit')}}" autocomplete="off">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="pg">Pengarang</label>
                                    <input type="text" id="pg" name="pengarang" class="form-control" value="{{old('pengarang')}}" autocomplete="off">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="jb">Jumlah Buku</label>
                                    <input type="number" id="jb" name="jumlah_buku" class="form-control" value="{{old('jumlah_buku')}}" autocomplete="off">
                                </div>
                                <div class="form-group mb-3">
